...
export function calculateInventoryForecast(data) {
  ...
  function buildCase(mode) {
    ...
    for (let i=0;i<156;i++) {
      ...
      weeks.push({week:i+1, weekStart, planned_nt:planned, shipped_nt:shipped, beginning_inventory_nt:beginning, ending_inventory_nt:remaining, details});
